      ...
      if(tag){
        if(this.id==''){
          ...
          var a = document.createElement('a');
              a.setAttribute('href','../html/commdetails.html?id='+this.id+'&'+'stepid='+this.stepid);
              a.setAttribute('target', 'aaa');
              a.click();
          // a('../html/commdetails.html?id='+this.id+'&'+'stepid='+this.stepid+ '&goods=' + this.goods,"aaa");
        }
      }else{
        ...
        callback: action => {
          this.template_id=str+1;
            ...
            if(this.template_id==2){
              window.location.href="../html/details1.html?student_id="+this.studentid + "&template_id=2";
            }
        }
      });
    },
