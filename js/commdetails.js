    ...
    shouYe(num,bol){
      ...
      if(num==1 && bol){
        var a = document.createElement('a');
              a.setAttribute('href',"../html/details.html?student_id="+this.student_id);
              a.setAttribute('target', 'xiang1');
              a.click();
        // window.open("../html/details.html?student_id="+this.student_id + "&goods=" + pub._LinkParm('goods') ,"xiang1");
      }else if(num==2 && !bol){
        var b = document.createElement('a');
              b.setAttribute('href', "../html/usecenter.html?student_id="+this.student_id+'#p1');
              b.setAttribute('target', 'xiang1');
              b.click();
        // window.open("../html/usecenter.html?student_id="+this.student_id+'#p1',"xiang1");
      }else{
        var c = document.createElement('a');
              c.setAttribute('href', "../index.html?student_id="+this.meid);
              c.setAttribute('target', 'xiang1');
              c.click();
        // window.open("../index.html?student_id="+this.meid,"xiang1");
      }
    },
