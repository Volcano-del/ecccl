var index = new Vue({
  ...
  methods:{
      ...
      pub._InitAxios({
        ...
        cbk:function cbk(res){
          if(res.stateCode=="200"){
            ...
            _this.lunboimglist=res.data.Lunboimages_bo;//轮播图内容
            _this.dibackImageUrl=res.data.dibackImageUrl;//模块背景
            _this.diMoImageUrl=res.data.diMoImageUrl;//木块标题
            _this.diTopImageUrl=res.data.diTopImageUrl;//返回顶部
            _this.goods=res.data.goods;//宝贝主图
    ...
    detail(detail_id){
      ...
      if(detail_id!=""){
        window.location.href="../html/commdetails1.html?id="+this.commdetails_id+'&'+'stepid='+this.getid+'&'+'dw='+1;
      }else{
        this.$message({
          message: '该商品没有配置详情',
          type: 'warning'
    ...
    shouYe(num,bol){
      ...
      if(num==1 && bol){
        ...
        a.setAttribute('href',"../html/storeopt1.html?student_id="+this.meid);
        a.setAttribute('target', 'shou2');
        a.click();
        // window.open("../html/storeopt1.html?student_id="+this.meid,"shou2");
      }else if(num==2 && !bol){
        var b = document.createElement('a');
        b.setAttribute('href', "../html/usecenter.html?student_id="+this.meid+'#p1');
        b.setAttribute('target', 'shou2');
        b.click();
        // window.open("../html/usecenter.html?student_id="+this.meid+'#p1',"shou2");
      }else{
        var c = document.createElement('a');
              c.setAttribute('href', "../index.html?student_id="+this.meid);
              c.setAttribute('target', 'shou2');
              c.click();
        // window.open("../index.html?student_id="+this.meid,"shou2");
      }
    },
    ...
    //商品列表的详情跳转
    goemel(id){
      window.location.href="../html/commdetails1.html?id="+id+'&'+'stepid='+this.getid+'&'+'dw='+1
    }
